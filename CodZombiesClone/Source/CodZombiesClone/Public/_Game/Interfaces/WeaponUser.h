...
public:
	...
	virtual void PlayWeaponMontage(UAnimMontage* Montage, float PlayRate = 1.0f) = 0;
	virtual bool TryEquipWeapon(TSubclassOf<ABaseWeapon> WeaponClass, FDataTableRowHandle WeaponData) = 0;
